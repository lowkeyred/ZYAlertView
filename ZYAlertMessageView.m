//
//  ZYAlertMessageView.m
//  FKGPopSelected
//
//  Created by 凡城软件 on 16/12/7.
//  Copyright © 2016年 forkingghost. All rights reserved.
//

#import "ZYAlertMessageView.h"
@interface ZYAlertMessageView ()
@property (nonnull, strong) UIView *backgroundView;
@property (nonatomic, weak) ZYPopOptionBlock optionBlock;
@end
@implementation ZYAlertMessageView
...
- (instancetype) option_setupPopOption:(ZYPopOptionBlock)block whichFrame:(CGRect)frame animate:(BOOL)animate {
